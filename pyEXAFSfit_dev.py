...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        def dialog_for_OpenFile(dir,str_caption,str_filter):
            print ("dialog_for_OpenFile:L350")
            ...
            file = FO_dialog.getOpenFileName(None, str_caption,
                                                            dat_dir, str_filter)
            print ("dialog_for_OpenFile:L358")
        ...
        def dialog_for_OpenFiles(dir,str_caption,str_filter):
            ...
            files = FO_dialog.getOpenFileNames(None, 'Select chi/xi files',
                                                            dat_dir, str_filter)
        ...
        def setOutputFile():
            ...
            ofile = FO_dialog.getSaveFileName(None, 'set output file name',
                                                            dat_dir, "Output File(*.csv *.dat)")
            if ofile[0] != '':
        ...
        self.u.combo_fitParam.currentIndexChanged.connect(self.child_plot_paramResult)
    ...
    def child_plot_paramResult(self):
        currentText = self.u.combo_fitParam.currentText()
        self.fig2.delaxes(self.ax2)
        self.ax2 = self.fig2.add_subplot(111)
        self.ax2.set_xlabel('X')
    ...
    def DoAction(self):
        if  self.timer.isActive():
            ...
            self.u.combo_fitParam.currentIndexChanged.disconnect(self.child_plot_paramResult)
            if self.u.cB_multifit.isChecked():
